defmodule Laboratory1 do
  ...
  def cartesianProduct(list1, list2) do
...
IO.inspect(Laboratory1.lettersCombinations("2643"))
IO.inspect(Laboratory1.groupAnagrams(["eat", "tea", "tan", "ate", "nat", "bat"]))
